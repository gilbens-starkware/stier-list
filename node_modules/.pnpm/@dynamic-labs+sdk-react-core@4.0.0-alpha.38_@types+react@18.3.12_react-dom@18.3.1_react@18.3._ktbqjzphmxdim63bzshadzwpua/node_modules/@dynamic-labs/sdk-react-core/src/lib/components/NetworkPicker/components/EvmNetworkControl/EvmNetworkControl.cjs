...
const EvmNetworkControl = ({ evmNetworks, className = '', activeClassName = '', network, walletConnector, isOpen, setIsOpen, showNetworkName = false, }) => {
    ...
    if (!network) {
        ...
        if (walletConnector && !walletConnector.isAvailable) {
            return (jsxRuntime.jsxs("div", { "data-testid": 'EvmNetworkControl', className: classNames.classNames(className, {
                ...
                }), children: [jsxRuntime.jsx(Icon.Icon, { size: 'small', children: jsxRuntime.jsx("img", { src: fallbackChainData.iconUrl, alt: `${fallbackChainData.name} icon` }) }), showNetworkName && (jsxRuntime.jsx(Typography.Typography, { className: 'evm-network-control__network-name', as: 'span', variant: 'body_small', children: fallbackChainData.name }))] }));
        }
