...
const WalletConnectorEvents = () => {
    const { walletConnectorOptions: walletConnectorOptions$1, primaryWallet } = useInternalDynamicContext.useInternalDynamicContext();
    ...
    }, [handleWalletItemClick, walletConnectorOptions$1, primaryWallet]);
    return null;
};
