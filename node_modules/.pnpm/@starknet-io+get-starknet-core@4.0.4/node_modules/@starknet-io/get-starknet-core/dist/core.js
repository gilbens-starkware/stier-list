...
var O = (t, e, n) => (Z(t, typeof e != "symbol" ? e + "" : e, n), n), Y = (t, e, n) => {
  if (!e.has(t))
    ...
    if (z) {
      ...
      for (let b = 0; b < D; b++) {
        ...
        t.hooks.lifecycle.handlePreloadModule.emit({
          ...
          remote: p,
          origin: t
        }), !getPreloaded(U) && (y.resourceCategory === "all" ? (s.push(...S(w.assets.css.async)), s.push(...S(w.assets.css.sync)), i.push(...S(w.assets.js.async)), i.push(...S(w.assets.js.sync))) : (y.resourceCategory = "sync") && (s.push(...S(w.assets.css.sync)), i.push(...S(w.assets.js.sync))), setPreloaded(U));
      }
    }
