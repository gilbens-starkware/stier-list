...
const InnerDynamicContextProvider = ({ children, theme, settings: settings$1, locale: locale$1, enableInstrumentation = false, }) => {
    ...
    let { appLogoUrl = 'https://demo.dynamic.xyz/assets/dynamic-logo.svg', appName = 'Dynamic Example', } = settings$1;
    if (!environmentId) {
    ...
    const [confirmationModal, walletUiUtils] = useWalletUiUtils.useWalletUiUtils({
        appLogoUrl,
        appName,
        hideEmbeddedWalletTransactionUIs: !((_o = (_m = projectSettings$1 === null || projectSettings$1 === void 0 ? void 0 : projectSettings$1.sdk) === null || _m === void 0 ? void 0 : _m.embeddedWallets) === null || _o === void 0 ? void 0 : _o.showEmbeddedWalletActionsUI),
    });
    useCreateWalletConnectorOptions.useCreateWalletConnectorOptions({
        appLogoUrl,
        appName,
    ...
    const walletConnectorOptions$1 = walletConnectorOptions.useWalletConnectorOptions();
    ...
    const bridgeChainsToConnect = React.useMemo(() => getMissingChains.getMissingChains(bridgeChains, connectedWalletsInfo), [bridgeChains, connectedWalletsInfo]);
    const { selectedWalletConnector, setSelectedWalletConnectorKey } = useSelectedWalletConnector.useSelectedWalletConnector({ walletConnectorOptions: walletConnectorOptions$1 });
    ...
    useSetWalletConnectorVerifiedCredentials.useSetWalletConnectorVerifiedCredentials(user$1 !== null && user$1 !== void 0 ? user$1 : userWithMissingInfo, walletConnectorOptions$1);
    useSetWalletConnectorFetchers.useSetWalletConnectorFetchers(walletConnectorOptions$1, environmentId, projectSettings$1);
    ...
    projectSettings.useFetchProjectSettings({ environmentId });
    ...
    const value = React.useMemo(() => {
        ...
        return ({
            ...
            legacyIsVerifying,
            linkedWallets: authMode === 'connect-only' || !user$1 ? [] : linkedOrConnectedWallets,
            loadingNetwork,
            locale: {
