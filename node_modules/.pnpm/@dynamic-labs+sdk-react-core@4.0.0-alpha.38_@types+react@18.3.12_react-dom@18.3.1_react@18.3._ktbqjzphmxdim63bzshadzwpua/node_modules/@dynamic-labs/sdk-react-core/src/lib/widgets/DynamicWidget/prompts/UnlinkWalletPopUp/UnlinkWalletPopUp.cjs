...
const UnlinkWalletPopUpContent = ({ onClickCancel, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: 'unlink-wallet-popup__container', children: [jsxRuntime.jsx(Typography.Typography, { color: 'primary', className: 'unlink-wallet-popup__title', variant: 'body_normal', as: 'h6', children: authMode === 'connect-only'
                    ...
                    : t('dyn_unlink_wallet_pop_up.unlink_description') }), jsxRuntime.jsx(TypographyButton.TypographyButton, { buttonPadding: 'small', onClick: onConfirmClick, disabled: loading, buttonClassName: 'unlink-wallet-popup__button unlink-wallet-popup__button--shadow', color: 'primary', expanded: true, typographyProps: {
