...
const ReconnectWithQrCodeView = ({ onCancel, onSuccess, connector, expectedAddress, }) => {
    ...
    return (jsxRuntime.jsx(DefaultPromptModal.DefaultPromptModal, { dataTestId: 'reconnect-qr-code', title: t('dyn_sync_wallet.reconnect_with_qr_code.title'), onClose: onCancel, children: qrcodeUri && (jsxRuntime.jsx(QrCodeWrapper.QrCodeWrapper, { uri: qrcodeUri, desktopUri: desktopUri, accentColor: 
