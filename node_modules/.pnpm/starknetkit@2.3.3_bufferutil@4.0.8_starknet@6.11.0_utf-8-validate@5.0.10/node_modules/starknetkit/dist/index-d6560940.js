...
var s = (A, D, M) => D in A ? L(A, D, { enumerable: !0, configurable: !0, writable: !0, value: M }) : A[D] = M;
var t = (A, D, M) => (s(A, typeof D != "symbol" ? D + "" : D, M), M);
import { Account as e } from "starknet";
import { C as y, a as g, b as i, P as T, U as c, r as C } from "./connector-c50f5de7.js";
...
class x extends y {
  ...
  async connect(M) {
    ...
    }), this._wallet.on("networkChanged", (z, u) => {
      this.onNetworkChanged(z, u);
