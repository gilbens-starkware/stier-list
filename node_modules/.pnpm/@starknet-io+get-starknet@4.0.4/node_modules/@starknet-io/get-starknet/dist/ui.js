    ...
    p(g, [I]) {
      if (I & 26) {
        ...
        for (M = 0; M < p.length; M += 1) {
          const D = get_each_context_1(g, p, M);
      ...
      if (I & 9) {
        ...
        for (M = 0; M < y.length; M += 1) {
          const D = get_each_context(g, y, M);
...
function generateSnapshotFromManifest(t) {
  ...
  if (!Object.keys(s).length) {
    var p;
    m = ((p = t.remotes) === null || p === void 0 ? void 0 : p.reduce(function(S, z) {
      var U, B = z.federationContainerName;
      return d.includes(B) ? U = a[B] : "version" in z ? U = z.version : U = z.entry, S[B] = {
        matchedVersion: U
      }, S;
    }, {})) || {};
  }
  ...
  var h = t.metaData, y = h.remoteEntry, w = y.path, g = y.name, I = y.type, M = h.types, D = h.buildInfo.buildVersion, j = h.globalName, E = t.exposes, b = {
    version: c || "",
    buildVersion: D,
    globalName: j,
    ...
    modules: E == null ? void 0 : E.map(function(S) {
      return {
        moduleName: S.name,
        modulePath: S.path,
        assets: S.assets
...
function generatePreloadAssets(t, e, r, n, o) {
  ...
  traverseModuleInfo(n, r, (h, y, w) => {
    ...
    const D = normalizePreloadExposes(g.exposes);
    if (D.length && "modules" in h) {
      var j;
      M = h == null || (j = h.modules) == null ? void 0 : j.reduce((b, A) => ((D == null ? void 0 : D.indexOf(A.moduleName)) !== -1 && b.push(A), b), []);
    }
    function E(b) {
    ...
    if (M) {
      ...
      for (let A = 0; A < b; A++) {
        ...
        t.hooks.lifecycle.handlePreloadModule.emit({
          ...
          remote: y,
          origin: t
        }), !getPreloaded(L) && (g.resourceCategory === "all" ? (s.push(...E(v.assets.css.async)), s.push(...E(v.assets.css.sync)), i.push(...E(v.assets.js.async)), i.push(...E(v.assets.js.sync))) : (g.resourceCategory = "sync") && (s.push(...E(v.assets.css.sync)), i.push(...E(v.assets.js.sync))), setPreloaded(L));
      }
    }
