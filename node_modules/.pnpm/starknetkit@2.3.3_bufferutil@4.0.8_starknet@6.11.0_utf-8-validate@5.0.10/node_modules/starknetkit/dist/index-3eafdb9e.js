...
const jn = 385, Ln = 775, $n = 385, Mn = 440;
function Dn(t) {
  return t;
}
function Zn(t) {
...
function ts(t) {
  ...
  const [c, u] = ht.css[r], l = `
    ...
    padding: 2px;
  `;
  return i.push("%c", e === "up" ? ">>" : "<<", r, `#${s}`, `%c${n}%c`, "%O"), o.push(l, `${l}; font-weight: bold;`, `${l}; font-weight: normal;`), e === "up" ? o.push({
    input: a,
    context: t.context
  }) : o.push({
    input: a,
...
function jr(t) {
  return function(r) {
    ...
    const i = {
      ...
      getErrorShape(c) {
        const { path: u, error: l } = c, { code: h } = c.error, y = {
          message: l.message,
          code: nt[h],
          data: {
            code: h,
        ...
        return await o({
          ...
          next(u) {
            ...
            return s({
              ...
              input: l && "input" in l ? l.input : i.input,
              rawInput: l && "rawInput" in l ? l.rawInput : i.rawInput
            });
          }
        });
      } catch (o) {
...
function Br(t) {
  return "input" in t ? t.runtime.transformer.serialize(t.input) : js(t.inputs.map((e) => t.runtime.transformer.serialize(e)));
}
const Vr = (t) => {
  let e = t.url + "/" + t.path;
  const r = [];
...
function _t(t) {
  ...
  function a() {
    ...
    for (const c of o) {
      ...
      }, { promise: h, cancel: y } = t.fetch(u.items.map((k) => k.key), l);
      u.cancel = y, h.then((k) => {
...
function Gr(t) {
  return function(r) {
    ...
    return (a) => {
      ...
      }, o = _t(i("query")), c = _t(i("mutation")), u = _t(i("subscription")), l = {
        query: o,
        subscription: u,
        mutation: c
      };
      return ({ op: h }) => Ms.observable((y) => {
        const k = l[h.type], { promise: T, cancel: N } = k.load(h);
        let oe;
        return T.then(($) => {
          oe = $;
...
function Xr(t) {
  return (e) => {
    ...
    return (n) => ({ op: s }) => Ws.observable((a) => {
      const { path: i, input: o, type: c } = s, { promise: u, cancel: l } = t.requester({
        ...r,
        runtime: n,
        type: c,
        path: i,
...
function Xs(t) {
  ...
  let c = 0, u = null, l = null, h = Xt(), y = "connecting";
  function k() {
  ...
  function Xt() {
    ...
    clearTimeout(l), l = null, S.addEventListener("open", () => {
      /* istanbul ignore next -- @preserve */
      S === h && (c = 0, y = "open", s?.(), k());
    ...
    const ce = (j) => {
      ...
      if (E) {
        if (E.callbacks.next?.(j), E.ws !== h && S === h) {
          const J = E.ws;
          E.ws = h, $(J);
        }
        "result" in j && j.result.type === "stopped" && S === h && E.callbacks.complete();
      }
    };
    return S.addEventListener("message", ({ data: j }) => {
      const E = JSON.parse(j);
      "method" in E ? ce(E) : ft(E), (S !== h || y === "closed") && $(S);
    }), S.addEventListener("close", ({ code: j }) => {
      y === "open" && a?.({
        code: j
      }), h === S && T();
  ...
  function Qt(R, S) {
    const { type: ce, input: ft, path: j, id: E } = R, J = {
      id: E,
      method: ce,
      params: {
        input: ft,
  ...
  return {
    close: () => {
      y = "closed", a?.(), F(), $(h), clearTimeout(l), l = null;
    },
    request: Qt,
    getConnection() {
      return h;
...
function Qs(t) {
  return (e) => {
    ...
    return ({ op: n }) => Js.observable((s) => {
      const { type: a, path: i, id: o, context: c } = n, u = e.transformer.serialize(n.input), l = r.request({
        type: a,
        path: i,
        input: u,
        id: o,
      ...
      n = t.createPopup(), await Promise.race([
        ...
        new Promise((i) => {
          a.addEventListener("message", (o) => {
            o.data === ja.TRPC_BROWSER_LOADED_EVENT && i();
          });
        }),
...
const v = Object.freeze({
  status: "aborted"
}), pe = (t) => ({ status: "dirty", value: t }), A = (t) => ({ status: "valid", value: t }), Pt = (t) => t.status === "aborted", Nt = (t) => t.status === "dirty", Pe = (t) => t.status === "valid", Ne = (t) => typeof Promise < "u" && t instanceof Promise;
function Ye(t, e, r, n) {
  if (r === "a" && !n)
...
function b(t) {
  ...
  return e ? { errorMap: e, description: s } : { errorMap: (i, o) => {
    var c, u;
    const { message: l } = t;
    return i.code === "invalid_enum_value" ? { message: l ?? o.defaultError } : typeof o.data > "u" ? { message: (c = l ?? n) !== null && c !== void 0 ? c : o.defaultError } : i.code !== "invalid_type" ? { message: o.defaultError } : { message: (u = l ?? r) !== null && u !== void 0 ? u : o.defaultError };
  }, description: s };
}
class w {
  constructor(e) {
  ...
  _parse(e) {
    ...
    for (const u of i) {
      ...
      c.push({
        ...
        value: l._parse(new B(s, h, s.path, u)),
    ...
    return s.common.async ? Promise.resolve().then(async () => {
      const u = [];
      for (const l of c) {
        const h = await l.key, y = await l.value;
        u.push({
          key: h,
          value: y,
...
const G = (t) => t instanceof De ? G(t.schema) : t instanceof W ? G(t.innerType()) : t instanceof Ze ? [t.value] : t instanceof ee ? t.options : t instanceof Ue ? x.objectValues(t.enum) : t instanceof We ? G(t._def.innerType) : t instanceof Ae ? [void 0] : t instanceof je ? [null] : t instanceof z ? [void 0, ...G(t.unwrap())] : t instanceof te ? [null, ...G(t.unwrap())] : t instanceof Gt || t instanceof ze ? G(t.unwrap()) : t instanceof qe ? G(t._def.innerType) : [];
class dt extends w {
  _parse(e) {
  ...
  _parse(e) {
    ...
    if (this._def.returns instanceof _e) {
      ...
      return A(async function(...c) {
        const u = new L([]), l = await o._def.args.parseAsync(c, a).catch((k) => {
...
class z extends w {
  _parse(e) {
    return this._getType(e) === m.undefined ? A(void 0) : this._def.innerType._parse(e);
  }
  unwrap() {
...
class te extends w {
  _parse(e) {
    return this._getType(e) === m.null ? A(null) : this._def.innerType._parse(e);
  }
  unwrap() {
    return this._def.innerType;
  }
...
}) => mn((r) => r instanceof t, e), yn = Z.create, gn = Q.create, si = et.create, ai = K.create, _n = Ie.create, ii = ae.create, oi = Xe.create, ci = Ae.create, ui = je.create, li = ge.create, di = se.create, fi = Y.create, pi = Qe.create, hi = U.create, mi = C.create, yi = C.strictCreate, gi = Le.create, _i = dt.create, vi = $e.create, bi = V.create, wi = Me.create, xi = Ke.create, ki = ie.create, Ti = he.create, Ei = De.create, Ci = Ze.create, Ri = ee.create, Oi = Ue.create, Si = _e.create, vr = W.create, Pi = z.create, Ni = te.create, Ii = W.createWithPreprocess, Ai = Be.create, ji = () => yn().optional(), Li = () => gn().optional(), $i = () => _n().optional(), Mi = {
...
const vn = /^0x[0-9a-f]+$/i, bn = /^\d+$/, Zi = d.string().min(1, "The short string cannot be empty").max(31, "The short string cannot exceed 31 characters").refine(
  (t) => !vn.test(t),
  ...
  entrypoint: d.string(),
  calldata: d.array(D.or(d.array(D))).optional()
}), At = d.array(tt).nonempty(), Ui = d.object({
  types: d.record(
    d.array(
      d.union([
        d.object({
  ...
  addStarknetChain: d.tuple([Wi]),
  switchStarknetChain: d.tuple([
    d.object({
      chainId: d.string()
    })
  ]),
  watchAsset: d.tuple([jt]),
...
const Mt = ({
  ...
  const a = window?.outerWidth ?? window?.innerWidth ?? window?.screen.width ?? 0, i = window?.outerHeight ?? window?.innerHeight ?? window?.screen.height ?? 0, o = window?.screenLeft ?? window?.screenX ?? 0, c = window?.screenTop ?? window?.screenY ?? 0, u = s ? 0 : o + a / 2 - t / 2, l = s ? window.screen.availHeight + 10 : c + i / 2 - e / 2;
  Lt = r ?? Lt, $t = n ?? $t, xn = `width=${t},height=${e},top=${l},left=${u},toolbar=no,menubar=no,scrollbars=no,location=no,status=no,popup=1`;
};
P.router({
  authorize: P.procedure.output(d.boolean()).mutation(async () => !0),
  connect: P.procedure.mutation(async () => ""),
  connectWebwallet: P.procedure.output(
    d.object({
      account: d.string().array().optional(),
      chainId: d.string().optional()
    })
  ).mutation(async () => ({})),
  enable: P.procedure.output(d.string()).mutation(async () => ""),
  execute: P.procedure.input(xt.execute).output(d.string()).mutation(async () => ""),
  signMessage: P.procedure.input(xt.signMessage).output(d.string().array()).mutation(async () => []),
  ...
  // RPC Messages
  requestAccounts: P.procedure.input(d.object({ silent_mode: d.boolean().optional() })).output(d.string().array()).mutation(async () => []),
  requestChainId: P.procedure.output(d.string()).mutation(async () => ""),
  signTypedData: P.procedure.input(xt.signMessage).output(d.string().array()).mutation(async () => []),
  getPermissions: P.procedure.output(d.array(d.enum([Et.ACCOUNTS]))).mutation(async () => [Et.ACCOUNTS]),
  addInvokeTransaction: P.procedure.input(wn.or(qi)).output(d.string()).mutation(async (t) => ""),
...
const kt = ({
  ...
  connectWebwallet: () => e.connectWebwallet.mutate(),
  async request(n) {
    switch (n.type) {
  ...
  const s = An(t), { allowedDapps: a } = await Ki(s);
  if (a.includes(window.location.hostname)) {
    ...
    const { iframe: l, modal: h } = await Qi(t, !1), y = kt({
      iframe: l.contentWindow ?? void 0
    });
    return await Tt(
      t,
      y,
...
class oo extends On {
  ...
  async connect() {
    if (await this.ensureWallet(), !this._wallet)
      throw new Kt();
    try {
      const { account: r, chainId: n } = await this._wallet.connectWebwallet();
      if (!r || !n)
        return {};
      const s = tr(n);
      return ue = r[0], {
